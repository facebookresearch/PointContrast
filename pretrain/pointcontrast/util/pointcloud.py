...
def get_matching_indices_on_voxels(source, target, trans, voxel_size, search_voxel_size, K=None):
  source_copy = copy.deepcopy(source)
  target_copy = copy.deepcopy(target)
  source_copy.transform(trans)

  target_copy.points = o3d.utility.Vector3dVector(np.array(target_copy.points) * voxel_size)
  source_copy.points = o3d.utility.Vector3dVector(np.array(source_copy.points) * voxel_size)
...
def get_self_matching_indices(source, search_voxel_size, K=None):
  source_copy = copy.deepcopy(source)
